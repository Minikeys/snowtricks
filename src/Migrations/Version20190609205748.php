 ...
 */
final class Version20190609205748 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD author_id INT NOT NULL, ADD published TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trick DROP author_id, DROP published');
    }
}
