...
$('#modal-preview-media').on('shown.bs.modal', function (event) {
    ...
    if(type == 'picture'){
        ...
        modal.find('.modal-title').html('Preview Media ' + id);
        modal.find('.modal-body').html('<iframe width="480" height="270" src="https://www.youtube.com/embed/'+ link +'" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>');
